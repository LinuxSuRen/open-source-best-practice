> 本文潜在的目标人群：
>
> 正在（或希望）从事以下工作的人:技术岗（研发、测试运维）、运营、市场，其他对开源开放性协作感兴趣的人。
...
* 邀请贡献者参加社区的各类活动，例如：社区例会、Meetup等。鼓励贡献者深度参与社区。
...
在社区运营过程中，有很多好的实践和方法，例如：社交媒体、Meetup、SIG、Technical Oversight Committee (TOC) 等的运营。下面，给出部分组织形式的最佳实践指导。
